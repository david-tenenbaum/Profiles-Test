 CREATE OR REPLACE TEMPORARY TABLE INPUTVARTABLE_GONG_CALLS_D1B_44 AS (
 ...
 AS input_row_id,
                    ...
                    Material_gong_calls_d1b10da3_44.*
                FROM
                    Material_gong_calls_d1b10da3_44
                            ...
                            ON SALESFORCE_ID = Material_account_id_stitcher_53876bca_44_1.other_id
