 CREATE OR REPLACE TEMPORARY TABLE MATERIAL_ACCOUNT_PROFILE_2772263D_18_INTERNAL_EV_SF_OPPORTUNITY_ACCOUNT_ID AS (
	 ...
	 AS sf_opportunity_account_id
            ...
            RIGHT JOIN inputVarTable_sf_opportunity_c34_18 USING (account_main_id)
