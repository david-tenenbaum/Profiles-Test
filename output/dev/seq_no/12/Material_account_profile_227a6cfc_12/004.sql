 CREATE OR REPLACE TEMPORARY TABLE INPUTVARTABLE_SF_OPPORTUNITY_C34_12 AS (
 ...
 AS input_row_id,
                    ...
                    Material_sf_opportunity_c340c2a8_12.*
                FROM
                    Material_sf_opportunity_c340c2a8_12
                            ...
                            ON ACCOUNT_ID = Material_account_id_stitcher_6b1ce8f1_12_1.other_id
