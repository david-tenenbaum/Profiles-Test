 CREATE OR REPLACE TEMPORARY TABLE INPUTVARTABLE_GONG_CALLS_D1B_42 AS (
 ...
 AS input_row_id,
                    ...
                    Material_gong_calls_d1b10da3_42.*
                FROM
                    Material_gong_calls_d1b10da3_42
                            ...
                            ON SALESFORCE_ID = Material_account_id_stitcher_53876bca_42_1.other_id
