 CREATE OR REPLACE TEMPORARY TABLE INPUTVARTABLE_SF_OPPORTUNITY_6B3_38 AS (
 ...
 AS input_row_id,
                    ...
                    Material_sf_opportunity_6b36e39e_38.*
                FROM
                    Material_sf_opportunity_6b36e39e_38
                            ...
                            ON ACCOUNT_ID = Material_account_id_stitcher_53876bca_38_1.other_id
