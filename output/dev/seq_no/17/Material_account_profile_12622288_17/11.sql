 CREATE OR REPLACE TEMPORARY TABLE MATERIAL_ACCOUNT_PROFILE_12622288_17_INTERNAL_EV_SF_OPPORTUNITY_ACCOUNT_ID AS (
	 ...
	 AS sf_opportunity_account_id
            ...
            RIGHT JOIN inputVarTable_sf_opportunity_c34_17 USING (account_main_id)
