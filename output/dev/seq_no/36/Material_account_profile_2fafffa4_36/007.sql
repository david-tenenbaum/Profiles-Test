 CREATE OR REPLACE TEMPORARY TABLE INPUTVARTABLE_SF_ACCOUNT_846_36 AS (
 ...
 AS input_row_id,
                    ...
                    Material_sf_account_84603234_36.*
                FROM
                    Material_sf_account_84603234_36
                            ...
                            ON case when account_status_c is not null then "ID" when record_type_id <> '0125x0000006uLeAAI' then "ID" when is_deleted = FALSE then "ID" end = Material_account_id_stitcher_f603b480_36_1.other_id
