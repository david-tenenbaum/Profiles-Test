 CREATE OR REPLACE TEMPORARY TABLE INPUTVARTABLE_SF_OPPORTUNITY_C34_31 AS (
 ...
 AS input_row_id,
                    ...
                    Material_sf_opportunity_c340c2a8_31.*
                FROM
                    Material_sf_opportunity_c340c2a8_31
                            ...
                            ON ACCOUNT_ID = Material_account_id_stitcher_6b1ce8f1_31_1.other_id
